        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              These core values guide everything we do at SkyFly Airlines
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                The safety and security of our passengers is our top priority in every flight operation.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <p className="text-gray-600">
                We strive for excellence in service delivery and operational performance every day.
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <p className="text-gray-600">
                Every passenger is valued, and we go the extra mile to ensure their comfort and satisfaction.
              </p>
            </div>
          </div>
        </div>
